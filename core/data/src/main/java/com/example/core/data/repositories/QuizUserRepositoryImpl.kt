...
import com.example.core.data.mappers.toQuizUser
import com.example.core.data.mappers.toQuizUserDto
import com.example.core.data.source.remote.ApiCallResult
import com.example.core.data.source.remote.api.QuizUserService
...
class QuizUserRepositoryImpl @Inject constructor(private val quizUserService: QuizUserService) :
    QuizUserRepository {
